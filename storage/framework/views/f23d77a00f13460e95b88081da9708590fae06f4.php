		...
		<div class="col-md-8">
			  ...
			  <table class="table table-hover">
                  ...
                  <tr>
					...
					<input type="text" name="birthday" value="<?php echo e($today->Day()); ?>/<?php echo e($today->Month()); ?>/<?php echo e($today->Year()); ?>" />
<?php $__env->startPush('scripts'); ?>
<script>
var b;
$(function() {
	b = moment([<?php echo e($today->Year()); ?>, <?php echo e($today->Month()); ?>, <?php echo e($today->Day()); ?>]);
  $('input[name="birthday"]').daterangepicker({
    singleDatePicker: true,
    showDropdowns: true,
    minYear: <?php echo e($today->Year()); ?>,
    maxYear: parseInt(moment().format('YYYY'),10)
		...
		if(d >0){
			b = a;
			$.ajax({
		url:"<?php echo e(url('admin/setdate/')); ?>",
		data:"_token=<?php echo e(csrf_token()); ?>&&date_now="+start.format("YYYY-MM-DD"),
		type:"post",
		success:function(t){
			if(t.status ==1){
