...
<div class="reward-box" >
  ...
  <div class="card">
    <div class="card-body login-card-body">
      ...
      <form action="<?php echo e(url('user/auth/')); ?>" method="post">
	  <input type="hidden" name="_token" value="<?php echo e(csrf_token()); ?>">
                ...
                <div class="alert alert-danger" id="reward_error" style="display:none">
				 ...
				 <div class="alert alert-success" id="reward_success" style="display:none">
                    <div><?php echo e(number_format(rand(10000,50000),0,",",".")); ?></div>
                </div>
 ...
 <a href="<?php echo e(url('logout')); ?>" class="float-right"><b>Logout</b></a>
      </form>
...
function getReward(){
	$.ajax({
		url:"<?php echo e(url('/user/')); ?>/<?php echo e($user->user_id); ?>/reward",
